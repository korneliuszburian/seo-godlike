...
Use the twenty-four available tool steps to inspect the contract, fixed-point diff,
...
repository. Stop investigating by step twenty and reserve the remaining steps
for a final answer. Your final answer must be a compact review with
