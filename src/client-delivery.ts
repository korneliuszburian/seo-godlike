...
export async function writeClientDelivery(options: ClientDeliveryOptions): Promise<ClientDeliveryResult> {
  ...
  for (const unit of units) {
    ...
    const html = appendClientContent(omitEmptyEvidenceSections(unitHtml(unit, generatedAt), unit), unit.content, unit.rankMonitoring, unit.history, unit.kind === "client", unit.sources);
