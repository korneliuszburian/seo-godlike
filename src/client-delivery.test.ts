...
test("client delivery splits unmapped phrase domains and keeps the client report separate", async () => {
  ...
  try {
    ...
    assert.match(clientHtml, /Google Search Console, Niedostępne — Ahrefs — dane nieaktualne, Niedostępne — Google Analytics 4, Zablokowane — Semstorm/);
    ...
    assert.match(clientHtml, /Brak zarejestrowanej numerycznej właściwości GA4/);
